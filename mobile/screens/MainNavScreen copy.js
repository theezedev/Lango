      ...
      <Tab.Screen
        ...
        options={{
          ...
          tabBarIcon: ({ color, size }) => (
            <Icon name="language" size={size} color={color}  style={{marginBottom:0,}}/>
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarShowLabel: false,
          tabBarIcon: ({ color, size }) => (
            <Icon name="albums" size={size} color={color} style={{marginBottom:0,}}/>
          ),
        }}
      />
      <Tab.Screen
        ...
        options={{
          ...
          tabBarShowLabel: false,
          tabBarIcon: ({ color, size }) => (
            <Icon name="settings-sharp" size={size} color={color} style={{marginBottom:0,}}/>
          ),
        }}
      />
    </Tab.Navigator>
